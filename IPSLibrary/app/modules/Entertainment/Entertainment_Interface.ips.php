<?
	 ...
	 *
	 * Dieses Script ist als Aktions Script f�r alle Variablen hinterlegt, die �ber das WebFront
	 * ver�ndert werden k�nnen.
	 *
	 * Zus�tzlich wird es auch von Register Variablen bzw. anderen Variablen per Event getriggert.
	 *
