<?
    function getLang($langId) {
		...
		$langString["ALARM_CLOSURE_OPEN_DETECTED_BODY"] = "%s: Öffnung von '%s' am Ort '%s' erkannt.";
		$langString["ALARM_CLOSURE_CLOSE_DETECTED_BODY"] = "%s: Schließung von '%s' am Ort '%s' erkannt.";
